...
public enum Lang {
    ...
    MODULE_ANTI_VAMPIRE_DESCRIPTION_BITCOMET_SEEDING,
    ...
    WEBAPI_ROUTE_NOT_EXISTS,
    WEBAPI_PLUGIN_OPERATION_COMPLETED,
    WEBAPI_PLUGIN_LOAD_FROM_UNSAFE_LOCATION,
    IPDB_GEOCN2_LOAD_DIVISION_MAP_BEGIN,
    IPDB_GEOCN2_LOAD_DIVISION_MAP_COMPLETE, DOWNLOADER_SERVER_TIMEOUT_RETRIEVE_PEERS, MODULE_STATUS_DESCRIPTION_ENABLED, MODULE_STATUS_DESCRIPTION_DISABLED, MODULE_STATUS_DESCRIPTION_NEED_RESTART, BTN_CONFIG_STATUS_SUCCESSFUL_READ_ONLY, MODULE_CHECK_UNEXCEPTED_EXCEPTION, DIGESTION_SYSTEM_DIGEST_RUNTIME_EXCEPTION, DIGESTION_SYSTEM_WATCH_EARLY_WARNING, DOWNLOADER_JSONRPC_REQUEST_FAILED, DOWNLOADER_ARIA2NEXT_INCORRECT_PRODUCT;
